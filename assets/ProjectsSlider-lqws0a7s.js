import{j as n}from"./vendor-animation-NadEQFtp.js";import{L as T,T as S,h as L,a as I,b as M,s as r,C as z,S as A,c as P,d as F,m as p,e as h,p as D,r as b}from"./index-MJJkFHMA.js";import{r as o,L as X}from"./vendor-react-DxOmqXaI.js";import"./vendor-utils-D24pSdc9.js";const Y=({project:s,additionalStyles:g,onanimationend:d})=>{const{currentLang:l}=o.useContext(T),{currentTheme:f}=o.useContext(S),c=o.useRef(null),x=f==="dark";return n.jsxs("div",{ref:c,id:`card-${s.title[l]}-container`,className:`
        group
        ${r.sizeFull}
      ...
      `,children:[n.jsxs("div",{id:"cards-stack-container",ref:x,className:`
        ...
        `,style:{perspective:F},onTouchStart:N,onTouchEnd:_,children:[d.map(t=>t),n.jsxs("div",{id:"mobile-swipe-indicator",className:`
            ...
            pointer-events-none
            animate-fade-in
          `,children:[n.jsx("span",{className:"text-[10px] font-mono uppercase tracking-widest",children:"Swipe !"}),n.jsx("img",{id:"swipe-icon",src:p.double_chevrons_icon.content[s],alt:p.double_chevrons_icon.alt,className:"w-6",style:{animation:"swipe-hint-projects-slider 2s infinite ease-in-out"}})]}),n.jsx("button",{id:"prev-button",className:`
            hidden md:block
            absolute
            ...
            duration-200
            ease-in-out
          `,onClick:$,children:n.jsx("img",{id:"icon-previous",src:p.double_chevrons_icon.content[s],alt:"previous button",className:`
              object-cover
              -rotate-90
              lg:w-7.5 md:w-10
